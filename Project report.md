...
On GitHub I wrote an introduction about myself. On LinkedIn I updated my education information. These websites are used for things. GitHub is for coding and technical skills. LinkedIn is for networking and looking professional.
...
I also made a quiz on Google Forms about Digital Literacy. The quiz had multiple-choice questions and short answers. I saw the answers on Google Sheets. This showed me how we can collect and analyze data easily.

These tools are really helpful for school. Coding platforms help us practice coding. Google Forms can be used for surveys and quizzes.
...
I also made a list of dos and don'ts for media to promote good online behavior. If a student sends an unclear email to a professor it can cause problems.
...
I was surprised by how people can fall victim to cybercrime. Many attacks use tricks like fake links or messages.
...
•	National Cyber Crime Portal (https://cybercrime.gov.in)a
